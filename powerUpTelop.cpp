...
#define POWERUPTELOP_BASEPOS_Y			(150.0f)			
...
static const D3DXVECTOR3 StartPos[POWERUPTELOP_SEQUENCE_MAX] = {
	D3DXVECTOR3(SCREEN_CENTER_X, POWERUPTELOP_BASEPOS_Y + 200.0f, 0.0f),
	D3DXVECTOR3(SCREEN_CENTER_X, POWERUPTELOP_BASEPOS_Y, 0.0f),
	D3DXVECTOR3(SCREEN_CENTER_X, POWERUPTELOP_BASEPOS_Y, 0.0f)
};
