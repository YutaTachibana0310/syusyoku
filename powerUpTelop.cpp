...
#define POWERUPTELOP_BASEPOS_Y			(200.0f)			
...
static const D3DXVECTOR3 StartPos[POWERUPTELOP_SEQUENCE_MAX] = {
	D3DXVECTOR3(SCREEN_WIDTH - POWERUPTELOP_TEX_SIZE_X, POWERUPTELOP_BASEPOS_Y + 200.0f, 0.0f),
	D3DXVECTOR3(SCREEN_WIDTH - POWERUPTELOP_TEX_SIZE_X, POWERUPTELOP_BASEPOS_Y, 0.0f),
	D3DXVECTOR3(SCREEN_WIDTH - POWERUPTELOP_TEX_SIZE_X, POWERUPTELOP_BASEPOS_Y, 0.0f)
};
