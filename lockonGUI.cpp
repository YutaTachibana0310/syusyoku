...
マクロ定義
***************************************/
#define LOCKONGUI_BASESCALE				(1.5f)
...
#define LOCKONGUI_TEXTTEX_SIZE_X		(90*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_TEXTTEX_SIZE_Y		(45*LOCKONGUI_BASESCALE	)

#define LOCKONGUI_NUMTEX_SIZE_X			(23*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_NUMTEX_SIZE_Y			(23*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_NUMTEX_OFFSET_X		(-25.0f*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_NUMTEX_OFFSET_Y		(50*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_NUMTEX_BASE_X			(-40*LOCKONGUI_BASESCALE	)

#define LOCKONGUI_BARTEX_NAME			"data/TEXTURE/UI/lockonBar.png"
#define LOCKONGUI_BARTEX_SIZE_X			(180.0f*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_BARTEX_SIZE_Y			(34.4f*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_BARTEX_OFFSET_Y		(50*LOCKONGUI_BASESCALE	)

#define LOCKONGUI_MAXTEX_NAME			"data/TEXTURE/UI/lockonMax.png"
#define LOCKONGUI_MAXTEX_SIZE_X			(30*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_MAXTEX_SIZE_Y			(30*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_MAXTEX_OFFSET_Y		(50*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_MAXTEX_OFFSET_X		(0)

#define LOCKONGUI_MAXNUMTEX_SIZE_X		(23*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_MAXNUMTEX_SIZE_Y		(23*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_MAXNUMTEX_OFFSET_X	(-25.0f*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_MAXNUMTEX_OFFSET_Y	(50*LOCKONGUI_BASESCALE	)
#define LOCKONGUI_MAXNUMTEX_BASE_X		(60*LOCKONGUI_BASESCALE	)
