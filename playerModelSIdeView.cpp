...
#define PLAYERSIDE_SHOTPOS_L			(D3DXVECTOR3(-5.0f, 0.0f, -15.0f))
#define PLAYERSIDE_SHOTPOS_R			(D3DXVECTOR3(5.0f, 0.0f, -15.0f))
...
void UpdatePlayerModelSideView(PLAYERMODEL *player)
{
	...
	player->destRot.z = -y * PLAYER_DESTROT_MAX;
	...
	//ロックオンGUIセット処理
	SetLockonGUIPos(player->id, player->pos + PLAYERSIDE_GUI_OFFSET);
