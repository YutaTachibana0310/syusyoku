...
#define EXPLOSIONFIRE_TEXNAME "data/TEXTURE/EFFECT/explosionFire.png"
...
static PARTICLE fire[EXPLOSIONFIRE_MAX];			//パーティクル構造体
...
void InitExplosionFire(int num)
{
	...
	{
		fire[i].pos = D3DXVECTOR3(-99999, -99999, -99999);
